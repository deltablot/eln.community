...
func NewCategoryHandler(categoryRepo CategoryRepository, adminRepo AdminRepository, sessionManager *scs.SessionManager, errorLogger *log.Logger) *CategoryHandler {
...
func (h *CategoryHandler) requireAdmin(next http.HandlerFunc) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		ctx := r.Context()
		orcid, ok := h.sessionManager.Get(ctx, "orcid").(string)
		if !ok || orcid == "" {
